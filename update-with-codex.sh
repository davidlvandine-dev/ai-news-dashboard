...
PROMPT='Update the AI News Dashboard snapshot for today using current web research. Refresh general AI company news, the IPO tracker, and the partnerships tracker. Track NVIDIA, Alphabet / Google DeepMind, Microsoft, OpenAI, Anthropic, Meta, Amazon / AWS, xAI, Broadcom, and Palantir for general news. Refresh IPO status for Anthropic, OpenAI, SpaceX / xAI, Cerebras Systems, Databricks, Scale AI, and any newly relevant AI IPO candidates. Refresh major AI partnerships and contracts including Anthropic-xAI/SpaceXAI, Anthropic-AWS, Anthropic-Google-Broadcom, Anthropic-Microsoft-NVIDIA, OpenAI-Microsoft, OpenAI-Amazon, OpenAI-NVIDIA, OpenAI-AMD, OpenAI-Oracle/SoftBank/CoreWeave, Meta-CoreWeave, Anthropic-CoreWeave, and Anthropic-Palantir-AWS. Write or update data/snapshots/YYYY-MM-DD.json for today using the existing JSON schema: date, generatedAt, title, companies[], ipoTracker[], partnershipTracker[], sources[]. Update data/index.json so latest points to today and the snapshots list includes today without duplicate dates, sorted newest first. Preserve all historical snapshots. Validate the JSON before finishing.'
